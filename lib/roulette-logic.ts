...
// Wheel group membership lists for statistics and history (WHEEL-BASED, not table-based!)
export const WHEEL_GROUPS = {
  ...
  right: [32, 15, 19, 4, 21, 2, 25, 17, 34, 6, 27, 13, 36, 11, 30, 8, 23, 10],
  left: [5, 24, 16, 33, 1, 20, 14, 31, 9, 22, 18, 29, 7, 28, 12, 35, 3, 26],
  // Wheel Quadrants (9's)
