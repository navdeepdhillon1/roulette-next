    ...
    <Card className="w-full max-w-4xl mx-auto p-4">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-3 gap-4 text-sm mb-6">
          <div className="bg-green-100 p-2 rounded">✅ Discipline: 100%</div>
          <div className="bg-yellow-100 p-2 rounded">⏱ Time: 12 min</div>
          <div className="bg-blue-100 p-2 rounded">🎯 Target: +$3</div>
        </div>
        ...
        <div className="border-t pt-4 mt-4">
          ...
          <Textarea
            placeholder="Add your reflection (e.g. 😌 Calm / 🎯 Disciplined / 😡 Tilt)"
            value={reflection}
